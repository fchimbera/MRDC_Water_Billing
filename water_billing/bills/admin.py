...
class MeterReadingAdmin(admin.ModelAdmin):
    list_display = ('account', 'reading_date', 'reading_value', 'is_billed', 'is_active', 'created_at')
    list_filter = ('reading_date', 'is_billed', 'is_active', 'account')
    search_fields = ('account__username', 'account__email', 'account__account_id')
...
class BillAdmin(admin.ModelAdmin):
    ...
    readonly_fields = (
        'user', 'meter_reading', 'previous_reading_value', 'consumption', 'rate_used',
        'amount_due', 'billing_period_start', 'billing_period_end', 'created_at'
    )
